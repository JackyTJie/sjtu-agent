...
项目\textbf{主要通过 Claude Code 等 AI 工具辅助开发}。AI 让我们在 45 天内完成了 12 个版本——学生对校园信息化的参与门槛已经大幅降低。有数据接口和平台支持，能做的远不止现在这些。
...
\begin{enumerate}[itemsep=4pt]
    ...
    \item \textbf{技术可控}——纯 Python，MIT 开源，数据本地存储，287 个自动化测试
...
\begin{enumerate}[itemsep=6pt]
    \item \textbf{帮同学省时间，不做越界的事。}不做考勤监控、不分析行为、不推送广告。Bot 提醒“今天有 3 个 DDL”，但怎么做是同学自己的事。
    \item \textbf{数据主权在学生。}随时导出、随时删除、可以选择不参与任何数据收集。
\end{enumerate}
